...
public class WebHttpSessionRequestCacheUnitTest
{
	...
	public void testCalcRedirectUrlWithEncodingAttrs()
	{
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("electronics/en", "/solahartstorefront/electronics/en",
						"https://electronics.local:9002/solahartstorefront/electronics/en"));
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("electronics/en", "/solahartstorefront/electronics/en",
						"https://electronics.local:9002/solahartstorefront/electronics/en/"));
	...
	public void testCalcRedirectUrlWithMismatchEncodingAttrs()
	{
		assertEquals(
				"electronics/en",
				executeCalculateRelativeRedirectUrl("electronics/ja/Y/Z", "/solahartstorefront/electronics/ja/Y/Z",
						"https://electronics.local:9002/solahartstorefront/electronics/en"));
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("electronics/ja/Y/Z", "/solahartstorefront/electronics/en",
						"https://electronics.local:9002/solahartstorefront/electronics/en/"));
	}
	...
	public void testCalcRedirectUrlWithoutEncodingAttrs()
	{
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("", "/solahartstorefront",
						"https://electronics.local:9002/solahartstorefront"));
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("", "/solahartstorefront",
						"https://electronics.local:9002/solahartstorefront/"));
	...
	public void testCalcRedirectUrlWithEncodingAttrsServletPath()
	{
		assertEquals(
				...
				executeCalculateRelativeRedirectUrl("electronics/en", "/solahartstorefront/electronics/en",
						"https://electronics.local:9002/solahartstorefront/electronics/en/Open-Catalogue/Cameras/Digital-Cameras/c/575"));
	}
