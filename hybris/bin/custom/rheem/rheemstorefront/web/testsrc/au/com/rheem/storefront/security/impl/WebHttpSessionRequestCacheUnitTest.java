...
public class WebHttpSessionRequestCacheUnitTest
{
	...
	public void testCalcRedirectUrlWithEncodingAttrs()
	{
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("electronics/en", "/rheemstorefront/electronics/en",
						"https://electronics.local:9002/rheemstorefront/electronics/en"));
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("electronics/en", "/rheemstorefront/electronics/en",
						"https://electronics.local:9002/rheemstorefront/electronics/en/"));
	...
	public void testCalcRedirectUrlWithMismatchEncodingAttrs()
	{
		assertEquals(
				"electronics/en",
				executeCalculateRelativeRedirectUrl("electronics/ja/Y/Z", "/rheemstorefront/electronics/ja/Y/Z",
						"https://electronics.local:9002/rheemstorefront/electronics/en"));
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("electronics/ja/Y/Z", "/rheemstorefront/electronics/en",
						"https://electronics.local:9002/rheemstorefront/electronics/en/"));
	}
	...
	public void testCalcRedirectUrlWithoutEncodingAttrs()
	{
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("", "/rheemstorefront",
						"https://electronics.local:9002/rheemstorefront"));
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("", "/rheemstorefront",
						"https://electronics.local:9002/rheemstorefront/"));
	...
	public void testCalcRedirectUrlWithEncodingAttrsServletPath()
	{
		assertEquals(
				...
				executeCalculateRelativeRedirectUrl("electronics/en", "/rheemstorefront/electronics/en",
						"https://electronics.local:9002/rheemstorefront/electronics/en/Open-Catalogue/Cameras/Digital-Cameras/c/575"));
	}
