 ...
 */
package au.com.rheem.test.setup;
...
import au.com.rheem.test.constants.RheemTestConstants;
import au.com.rheem.test.orders.AcceleratorTestOrderData;
 ...
 */
@SystemSetup(extension = RheemTestConstants.EXTENSIONNAME)
public class TestDataSystemSetup extends AbstractSystemSetup
{
	...
	public void createProjectData(final SystemSetupContext context)
	{
		if (getBooleanSystemSetupParameter(context, CREATE_TEST_DATA))
		{
			...
			importImpexFile(context, "/rheemtest/import/qa-test-users.impex");

			LOG.info("Creating Reviews...");
			importImpexFile(context, "/rheemtest/import/reviews.impex");

			LOG.info("Creating Test Payment Subscriptions...");
			getAcceleratorTestOrderData().createPaymentInfos();

			LOG.info("Creating CS Tickets...");
			importImpexFile(context, "/rheemtest/import/cstickets.impex");
			...
			importImpexFile(context, "/rheemtest/import/csquotes.impex");
		}
	}
}
